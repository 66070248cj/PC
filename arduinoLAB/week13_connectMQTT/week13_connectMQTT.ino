...
const char WIFI_SSID[] = "chanisara";          // CHANGE TO YOUR WIFI SSID
const char WIFI_PASSWORD[] = "tong12345";  // CHANGE TO YOUR WIFI PASSWORD

const char MQTT_BROKER_ADRRESS[] = "mqtt-dashboard.com";  // CHANGE TO MQTT BROKER'S ADDRESS
const int MQTT_PORT = 1883;
const char MQTT_CLIENT_ID[] = "clientId-NkZDFbbqKq";  // CHANGE IT AS YOU DESIRE
const char MQTT_USERNAME[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required
const char MQTT_PASSWORD[] = "";                                            // CHANGE IT IF REQUIRED, empty if not required

// The MQTT topics that Arduino should publish/subscribe
const char PUBLISH_TOPIC[] = "cjay/za55555";    // CHANGE IT AS YOU DESIRE
const char SUBSCRIBE_TOPIC[] = "cjay/za55555";  // CHANGE IT AS YOU DESIRE
